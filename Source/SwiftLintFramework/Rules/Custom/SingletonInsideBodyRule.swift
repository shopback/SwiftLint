...
public struct SingletonInsideBodyRule: OptInRule, ASTRule, ConfigurationProviderRule {
    ...
    public static let description = RuleDescription(
            ...
            description: "Singletons should not be called directly by using .shared inside method body but should be injected first.",
            kind: .idiomatic,
    ...
    public func validate(file: File, kind: SwiftDeclarationKind,
        ...
        return [StyleViolation(ruleDescription: type(of: self).description,
                ...
                location: Location(file: file, byteOffset: bodyOffset + occurrence.lowerBound.encodedOffset),
